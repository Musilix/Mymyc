...
export class BankingScenario {
    ...
    private  Accounting_Transaction_Event : ScenarioField = new ScenarioField({fieldValue: false});
    ...
    private  Day_Count_Convention : ScenarioField = new ScenarioField({fieldValue: false});
    private  Day_Of_Month : ScenarioField = new ScenarioField({fieldValue: false});
    ...
    private  Payroll_Service : ScenarioField = new ScenarioField({fieldValue: false});
    ...
    private  Principal_Repayment_Terms : ScenarioField = new ScenarioField({fieldValue: false});
    private  Principal_Underwriter : ScenarioField = new ScenarioField({fieldValue: false});
    private  Relationship_Manager : ScenarioField = new ScenarioField({fieldValue: false});
    private  Relationship_Qualifier : ScenarioField = new ScenarioField({fieldValue: false});
    private  Underwriter : ScenarioField = new ScenarioField({fieldValue: false});
    private  Underwriting_Arrangement : ScenarioField = new ScenarioField({fieldValue: false});
    private  Unilateral_Contract : ScenarioField = new ScenarioField({fieldValue: false});
    private  Variable_Interest_Rate : ScenarioField = new ScenarioField({fieldValue: false});
